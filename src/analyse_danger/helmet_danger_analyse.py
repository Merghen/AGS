...
class HelmetDangerAnalyzer(BaseDangerAnalyzer):   
    """ Kask tespiti için tehlike analizi yapar. """

    HELMET_VIOLATION = DangerInfo("Kask ihmali", "yellow")

    def __init__(self):
        super().__init__(use_duration_check=True, danger_duration_threshold=3)
        
    def compute_danger(self,frame_result):
       """ Kask tespiti için tehlike analizini yapar
       ...
       return self.analyze_equipment_danger(violation=self.HELMET_VIOLATION, frame_result=frame_result)